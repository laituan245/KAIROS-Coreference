...
def generate_visualization_for_cluster(docs, entity2mention, event2mention, cluster, cluster_nb):
    ...
    generate_visualization(docs, entity2mention, 'test/quizlet7_test/cluster_{}_entity_coref.html'.format(cluster_nb))
    generate_visualization(docs, event2mention, 'test/quizlet7_test/cluster_{}_event_coref.html'.format(cluster_nb))

# Main code
if __name__ == "__main__":
    # Parse argument
    parser = ArgumentParser()
    parser.add_argument('--json_dir', default='test/quizlet7_test/json')
    parser.add_argument('--coref_dir', default='test/quizlet7_test/all/')
