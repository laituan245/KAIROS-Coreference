...
def generate_visualization_for_cluster(docs, entity2mention, event2mention, cluster, cluster_nb):
    ...
    generate_visualization(docs, entity2mention, 'test/quizlet8_{}/cluster_{}_entity_coref.html'.format(TOPIC, cluster_nb))
    generate_visualization(docs, event2mention, 'test/quizlet8_{}/cluster_{}_event_coref.html'.format(TOPIC, cluster_nb))
...
if __name__ == "__main__":
    ...
    TOPIC = args.topic
    args.coref_dir = 'test/quizlet8_{}/all/'.format(args.topic)
    args.json_dir = 'test/quizlet8_{}/json'.format(args.topic)
